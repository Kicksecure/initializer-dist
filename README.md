...
See instructions. (Replace `generic-package` with the actual name of this package `initializer-dist`.)
...
`initializer-dist` requires [donations](https://www.whonix.org/wiki/Donate) to stay alive!
